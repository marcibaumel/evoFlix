    ...
    <>
      <Router>
        <IconContext.Provider value={{ color: "#fff" }}>
          <div
            className={sidebar && loggedIn===false ? "wrapper-navbar-nav-menu-active" : "wrapper"}
          >
            <div className={sidebar && loggedIn===false ? "navbar-nav-menu-active" : "navbar"}>
              <button className="navbar-button">
              ...
              {(() => {
                if (user === null || user === undefined)
                  ...
                  return (
                    <button className="navbar-button">
                      <Link className="navbar-link" to="/profilesettings">
                        Profile
                      </Link>
                    </button>
                  );
              ...
              render={(props) => (
                <>
                  <div className="content">
                    ...
                    <h2 className="welcomeText">
                      Ready to watch? Press the button in the
                      <a>
                        <span className="to-the-button-text">
                          right corner.
                        </span>
                      </a>
                    </h2>
                    <div className="imgCarousel-div">
                      ...
                      >
                        <div>
                          <img
                            src="https://variety.com/wp-content/uploads/2021/03/Shrek-Eddie-Murphy-1.jpg"
                            alt="m1"
                          />
                        ...
                        <div>
                          <img
                            src="https://www.indiewire.com/wp-content/uploads/2021/10/MCDBEMO_EC001.jpg?w=780"
                            alt="m2"
                          />
                        ...
                        <div>
                          <img
                            src="https://ntvb.tmsimg.com/assets/p20115224_v_h8_aa.jpg?w=1280&h=720"
                            alt="m3"
                          />
          ...
          <IconContext.Provider value={{ color: "#419D5D" }}>
            <nav className={sidebar && loggedIn===false ? "nav-menu active" : "nav-menu"}>
